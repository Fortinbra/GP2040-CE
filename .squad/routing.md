...
|-----------|----------|----------|
| Architecture, scope, doc strategy | Roy Mustang | Overall structure, feature prioritization, design decisions |
| Feature docs, guides, changelogs | Maes Hughes | Writing, formatting, user-facing content |
| C/C++ firmware internals, Pico SDK, hardware | Edward | Low-level behavior, pin mapping, USB HID, add-ons |
| Web configurator, React UI, config tool docs | Winry | Frontend component docs, config workflow |
| Accuracy review, doc quality gates | Riza | Reviewer — approval/rejection gatekeeper |
| Code review | Roy Mustang | Review PRs, check quality, suggest improvements |
| Testing | Riza | Edge cases, accuracy verification, quality assurance |
