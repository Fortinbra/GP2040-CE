...
/*!
 * Addendum:
 * File name and class name changed, and driver ported for use on the Raspberry Pi RP2040 Chip.
 * All original licenses remain.
 */
/**************************************************************************/
#ifndef _DRV2605_H
#define _DRV2605_H
...
class DRV2605L
{
	protected:
		...
		public:
			DRV2605L(PeripheralI2C *i2cController, uint8_t addr = DRV2605_ADDR);
